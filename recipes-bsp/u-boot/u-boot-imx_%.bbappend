...
do_install:append:mx93-nxp-bsp () {
    ...
    echo "/dev/mmcblk0 0x400000 0x4000" > ${D}/${sysconfdir}/fw_env.config
    echo "/dev/mmcblk0 0x404000 0x4000" >> ${D}/${sysconfdir}/fw_env.config
...
do_install:append:mx8mp-nxp-bsp () {
    ...
    echo "/dev/mmcblk2 0x404000 0x4000" >> ${D}/${sysconfdir}/fw_env.config
    echo "${MACHINE} ${SWU_HW_REV}" > ${D}/${sysconfdir}/hwrevision
